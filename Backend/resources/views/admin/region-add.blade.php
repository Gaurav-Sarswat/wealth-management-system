                            ...
                            <div class="card p-4">
                                <div class="auth-form-wrapper">
                                    <div class="auth-form">
                                        ...
                                        <form action="{{ route('admin.add-region') }}" method="POST">
                                            @csrf
                                            <div class="form-group">
                                                <x-input type="text" placeholder="Region" name="name" class="form-control" />
                                            </div>
                                            <button type="submit" class="mt-4 btn btn-custom w-100">Add Region</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
