    ...
    <div class="layout-main">
        ...
        <div class="content-wrapper py-2">
            <div class="container">
                ...
                <h5 class="page-title">Idea Drafts</h5>
            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-4 mb-3">
                            <div class="custom-card">
                                ...
                                <a href="FIXME:" class="btn btn-custom px-4 py-2 d-flex align-items-center justify-content-center">Edit <i class="fas fa-arrow-right ml-2"></i></a>
                            </div>
                        </div>
                        <div class="col-4 mb-3">
                            <div class="custom-card">
