                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="your-manager-wrapper card">
                                <figure>
                                    <img class="custom-rounded" src="{{ asset($user->manager->profile_picture) }}" onerror="this.src='{{'https://ui-avatars.com/api/?name='.$user->manager->name.'&background=327DF6&color=fff'}}'" alt="">
                                </figure>
